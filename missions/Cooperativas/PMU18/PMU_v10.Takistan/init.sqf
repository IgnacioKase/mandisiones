...
contenedor1 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf", malla1];
contenedor2 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf", malla2];
contenedor3 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf", malla3];
