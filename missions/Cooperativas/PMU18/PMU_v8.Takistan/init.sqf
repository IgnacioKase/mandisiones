...
player createDiaryRecord["Diary", ["Objetivo", "<p align='center'>-Destruir los antiaéreos</p>-Destruir la artillería</p><br/><p>-Destruir los morteros</p><br/><p>-Limpiar las zonas marcas.</p>"]];
...
contenedor1 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf"];
contenedor2 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf"];
contenedor3 addAction ["<t color='#58FA82'>Armar malla mimética</t>", "scripts\contenedor.sqf"];
