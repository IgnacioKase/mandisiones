...
force VCM_AIMagLimit = 1; 			//Número de cargadores restantes antes de que AI busque munición.
...
force VCM_HEARINGDISTANCE = 300; 	//Distancia AI escucha disparos no suprimidos.
...
force VCM_WARNDELAY = 60; 			//Cuánto tiempo tiene que sobrevivir la IA antes de poder pedir ayuda. Esto se activa una vez que la IA entra en combate.
force VCM_WARNDIST = 250; 			//Hasta qué distancia la AI puede solicitar ayuda de otros grupos.
