...
#define NAME "Op. Nombre de la mision V2"  // Colocar nombre de mision
#define IMAGE "imgs\portada.paa"        // Colocar nombre y extension de la imagen de portada, ej "imgs\portada.jpg"
#define DESCRIPTION "Rescatar al chabon de gravia"                  // Colocar descripcion de la mision entre las comillas

author = "Aca tu nombre";               // Editor (Pone tu nombre)
