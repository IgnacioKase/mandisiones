...
// [[[_al_flare],"scripts\flares.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;
...
// you need to list in array bellow the class names for flares you want to alter
	_type_flares = ["F_40mm_White","F_40mm_Red","F_40mm_Yellow","F_40mm_Green","Flare_82mm_AMOS_White", "ACE_HandFlare_White", "rhs_VG40OP_white"];
