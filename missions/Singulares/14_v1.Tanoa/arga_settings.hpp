...
#define NAME "Op. 14"                               // Colocar nombre de mision
#define COMPLETE_NAME "Op. 14"                      // Nombre y versión de la misión
...
TEMA_CORRECCION_COLOR = "Realidad_Marrón";
...
CLIMA = "Despejado";
UBICACION = "Tanoa";
SITUACION_HISTORICA = ["Las disputas por la frontera entre la URSS y Japón continúan. La situación está a punto de convertirse en un conflicto armado y Japón ya se encuentra preparado para esto.", "La URSS no dejará que Japón de el primer golpe, por lo tanto se decidió atacar la isla de Tanoa para utilizarla como base militar en el mar para el ataque al país."];
SITUACION = ["Se planeó una infiltración al puerto designado con el nombre en clave de Куб (Pronunciación: Kub). La operación empezó a las 00:00 pero la jungla nos jugó una mala pasada.", "Ya son las 0645 Hrs, ya hay luz de día y recien acabamos de llegar a las salidas del puerto. Continuaremos con la idea del ataque sorpresa y sigiloso, pero debido a la hora, debemos esperar lo peor.", "La escuadra форма (Pronunciación: Forma) atacará por el oeste y la escuadra цвета (Pronunciación: Tsveta) por el este. Debemos entrar, capturar el puerto y secuestrar a los ingenieros a cargo.", "Luego de la captura comandancia enviará soporte y helicópteros para realizar la extracción."];
EXTRACTO_INTELIGENCIA = [""];
OBJETIVOS = ["Capturar el puerto de <marker name='ky6'>Куб</marker>.", "Localizar y extraer a los ingenieros."];
RECURSOS = ["Armamento Ruso", "Radio personal"];
ENEMIGOS = ["Ejercito japonés", "Gran resistencia (Nos encontramos en su isla)"];
////////////////////////////////////////////////////////////////////////////////
