...
force VCM_ARTYSPREAD = 300; //Dispersion en metros
...
//force VCM_SIDEENABLED = [WEST,EAST,resistance]; //Lados que activarán Vcom AI
...
//force VCM_ARTYSIDES = [east,west];  //Lista de todas las IA dentro de las piezas de artillería, deja esto solo.