...
#define NAME "Capítulo IX"                  // Colocar nombre de mision
#define COMPLETE_NAME "Capítulo IX - El Señor de la Guerra v1"  // Nombre y versión de la misión
#define IMAGE "imgs\portada.paa"                    // Colocar nombre y extension de la imagen de portada, ej "imgs\portada.jpg"
#define DESCRIPTION "Desactivar el dispositivo"                              // Colocar descripcion de la mision entre las comillas
