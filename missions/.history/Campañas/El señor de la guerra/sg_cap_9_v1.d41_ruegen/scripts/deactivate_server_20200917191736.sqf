...
GUIA_DESACTIVACION =
{
	hint "Guía de desactivación:\n\nLa desactivación de la bomba cuenta de 3 pasos fundamentales. Estos se deben seguir al pie de la letra y en el orden especifico aqui comentado o el dispositivo detonará.\n\nPaso 1: Cortar el cable indicado: Ingrese al menú 'Pasos cables' y obtendrá información de que cable deberá cortar dependiende del dispositivo con el que desactivador se encuentre trabajando.\n\nPaso 2: Ingresar la contraseña. Menú 'Pasos contraseña'.\n\nPaso 3: Ingresar codigo de desactivación. Menú: 'Pasos código de desactivación'.\n\nLa comunicación con su compañero de desactivación es fundamental, pida y anote toda la información necesaria para";
};
