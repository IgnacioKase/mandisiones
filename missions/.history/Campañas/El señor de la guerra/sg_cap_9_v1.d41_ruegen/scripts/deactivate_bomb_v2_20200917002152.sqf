...
{
	["1JV86", ["INGRESAR_CODIDO_DESACTIVACION", "amarillo"]] call ADD_ACTION;
	["LGH3V cable blanco", ["INGRESAR_CODIDO_DESACTIVACION", "blanco"]] call ADD_ACTION;
	["2PB8M", ["INGRESAR_CODIDO_DESACTIVACION", "rojo"]] call ADD_ACTION;
	["APV84", ["INGRESAR_CODIDO_DESACTIVACION", "negro"]] call ADD_ACTION;
	["20BNW", "MENU_PRINCIPAL"] call ADD_ACTION;
};
