...
{
	["Cortar cable amarillo", ["INGRESAR_CODIDO_DESACTIVACION", "amarillo"]] call ADD_ACTION;
	["Cortar cable blanco", ["INGRESAR_CODIDO_DESACTIVACION", "blanco"]] call ADD_ACTION;
	["Cortar cable rojo", ["INGRESAR_CODIDO_DESACTIVACION", "rojo"]] call ADD_ACTION;
	["Cortar cable negro", ["INGRESAR_CODIDO_DESACTIVACION", "negro"]] call ADD_ACTION;
	["Volver al menú principal", "MENU_PRINCIPAL"] call ADD_ACTION;
};
