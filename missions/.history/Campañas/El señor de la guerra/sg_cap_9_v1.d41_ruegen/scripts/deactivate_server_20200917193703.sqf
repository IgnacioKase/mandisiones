...
PASOS_CODIGO =
{
	hint "Para obtener el código de desactivación necesita el Código de recuperación.\n\nSi el código de recuperación es 8510672: El código de desactivación es: 1JV86\n\nSi el código de recuperación es 8510672: El código de desactivación es: APV84\n\nSi el código de recuperación es 8510672: El código de desactivación es: 2PB8M\n\nSi el código de recuperación es 8510672: El código de desactivación es: LGH3V";
};
