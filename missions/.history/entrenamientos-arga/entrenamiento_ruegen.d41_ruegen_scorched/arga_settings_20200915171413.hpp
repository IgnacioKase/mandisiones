...
#define NAME "Entrenamiento ArgA Ruguen"
#define COMPLETE_NAME "Entrenamiento ArgA Ruguen 1.0"
...
ES_CAMPANIA = 0;
NOMBRE_CAMPANIA = "";
INTRO_PERSONALIZADA = 2;                            // 1 Si la deseas cargar una intro personalizada (propia)
