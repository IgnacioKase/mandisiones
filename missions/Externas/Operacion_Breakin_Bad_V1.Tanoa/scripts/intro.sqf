...
//["<t size='3' color='#222222'>Fin del Camino",0,0.4,1,2,0.0] spawn bis_fnc_dynamictext; //Si existe, si no, comentar con // y no se ejecutara el comando.
...
["<t size='0.9' color='#FFFFFF'>Fin del Camino",0,0.4,5,5,0.0] spawn bis_fnc_dynamictext;
