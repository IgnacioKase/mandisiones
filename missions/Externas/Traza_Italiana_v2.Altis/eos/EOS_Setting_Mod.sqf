...
EOS_FACCION = EAST;
publicVariable "EOS_FACCION";
_waves = 1;// Borrar

if (_jugadores <= 10) then {
  //null = [[_marker],[6,2],[0,0],[0],[0,0],[5,1,EAST,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
  null = [[_marker],[0,1,600],[0,0,500],[15,800],[0,1,1500],[3,4,500,600],[0,3,200,1000],[6,0,EOS_FACCION,TRUE,TRUE],[6,_waves,30,FALSE,TRUE],[_angle]] call Bastion_Spawn;
  //null = [[_marker],[0,1,600],[0,2,500],[0,300],[2,0,3000],[0,4,500,600],[0,3,200,1000],[1,0,WEST,TRUE,TRUE],[120,1,240,FALSE,TRUE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 10 && _jugadores <= 15) then {
  null = [[_marker],[8,2],[0,0],[0],[0,0],[5,1,EOS_FACCION,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 15 && _jugadores <= 20) then {
  null = [[_marker],[7,3],[0,0],[0],[0,0],[5,1,EOS_FACCION,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 20 && _jugadores <= 25) then {
  null = [[_marker],[9,3],[0,0],[0],[0,0],[5,1,EOS_FACCION,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
if (_jugadores > 25) then {
  null = [[_marker],[7,4],[0,0],[0],[0,0],[5,1,EOS_FACCION,TRUE],[60,_waves,600,FALSE,FALSE],[_angle]] call Bastion_Spawn;
};
