...
force VCM_AIDISTANCEVEHPATH = 2; //Distance AI check from the squad leader to steal vehicles
...
force VCM_STATICARMT = 200; //How long AI stay on static weapons when initially arming them. This is just for AI WITHOUT static bags. They will stay for this duration when NO ENEMIES ARE SEEN, or their group gets FAR away.
force VCM_StealVeh = true; //Will the AI steal vehicles.
force VCM_WARNDELAY = 40; //How long the AI have to survive before they can call in for support. This activates once the AI enter combat.
