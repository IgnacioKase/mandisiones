...
#define NAME "Rangers"                  // Colocar nombre de mision
#define COMPLETE_NAME "Rangers v4" // Nombre y versión de la misión
#define IMAGE "imgs\portada.jpg"                    // Colocar nombre y extension de la imagen de portada, ej "imgs\portada.jpg"
#define DESCRIPTION "El sigilo es nuestro mejor aliado"                              // Colocar descripcion de la mision entre las comillas

AUTHOR = "Cbo Axel";                                    // Editor (Pone tu nombre)
