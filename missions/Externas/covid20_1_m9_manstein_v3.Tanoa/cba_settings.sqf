...
force VCM_HEARINGDISTANCE = 600; //Distancia AI escucha disparos no suprimidos.
...
force VCM_WARNDELAY = 20; //Cuánto tiempo tiene que sobrevivir la IA antes de poder pedir ayuda. Esto se activa una vez que la IA entra en combate.
force VCM_WARNDIST = 600; //Hasta qué distancia la AI puede solicitar ayuda de otros grupos.
