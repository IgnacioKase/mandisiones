...
#define NAME "En busca del Fernet V4"                     // Colocar nombre de mision
#define IMAGE "imgs\portada.jpg"        // Colocar nombre y extension de la imagen de portada, ej "imgs\portada.jpg"
#define DESCRIPTION "En busca del Fernet Perdido"                  // Colocar descripcion de la mision entre las comillas

author = "Night";                        // Editor (Pone tu nombre)
