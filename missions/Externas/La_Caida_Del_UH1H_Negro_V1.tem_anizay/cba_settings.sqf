...
force VCM_ARTYSPREAD = 100; //Dispersion en metros
...
force VCM_HEARINGDISTANCE = 50; //Distancia AI escucha disparos no suprimidos.
force VCM_MINECHANCE = 75; //Probabilidad de poner una mina
force VCM_RAGDOLL = true; //Should AI ragdoll when hit
force VCM_RAGDOLLCHC =75; //CHANCE AI RAGDOLL
...
force VCM_WARNDIST = 35; //Hasta qué distancia la AI puede solicitar ayuda de otros grupos.
