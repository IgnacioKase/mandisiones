...
["<t size='3' color='#222222'>Lberando Virolahti",0,0.4,1,2,0.0] spawn bis_fnc_dynamictext; //Si existe, si no, comentar con // y no se ejecutara el comando.
...
["<t size='0.9' color='#FFFFFF'>",0,0.4,5,5,0.0] spawn bis_fnc_dynamictext;

any= ["Dia 3: Cortando la Brecha",
"Ubicacion: Virolahti",
 "HORA:06:00"
