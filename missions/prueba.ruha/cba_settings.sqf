...
force VCM_RAGDOLLCHC = 80; //CHANCE AI RAGDOLL
...
force VCM_WARNDELAY = 10; //How long the AI have to survive before they can call in for support. This activates once the AI enter combat.
