...
#define COMPLETE_NAME "Capítulo VI - El Señor de la Guerra v19" // Nombre y versión de la misión
...
EXTRACTO_INTELIGENCIA = ["<img image='imgs\o_taeyang.paa' width='323' height='323'/>", "<img image='imgs\manyoung.paa' width='323' height='323'/>", "<img image='imgs\yangyang.paa' width='323' height='323'/>", "<img image='imgs\pizarra.paa' width='400' height='200'/>"];
