...
#define NAME "Capítulo VII"                         // Colocar nombre de mision
#define COMPLETE_NAME "Capítulo VII - El Señor de la Guerra v1"  // Nombre y versión de la misión
#define IMAGE "imgs\portada.paa"                    // Colocar nombre y extension de la imagen de portada, ej "core\imgs\portada.jpg"
#define DESCRIPTION "Bienvenidos Ruegen"            // Colocar descripcion de la mision entre las comillas
