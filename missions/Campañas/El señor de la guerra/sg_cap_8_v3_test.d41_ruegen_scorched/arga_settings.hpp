...
#define NAME "Capítulo VIII"                         // Colocar nombre de mision
#define COMPLETE_NAME "Capítulo VIII - El Señor de la Guerra v3"  // Nombre y versión de la misión
#define IMAGE "imgs\portada.paa"                    // Colocar nombre y extension de la imagen de portada, ej "core\imgs\portada.jpg"
#define DESCRIPTION "Tomar la plaza"            // Colocar descripcion de la mision entre las comillas

author = "Maxi e Ignacio";                          // Editor (Pone tu nombre)
AUTHOR_UID = ["76561198026915573", "76561198091139370"]; // Colocar entre las comillas el numero que aparece en la lista de abajo. Si son mas de un autor poner con la forma ["nro 1", "nro 2"]
