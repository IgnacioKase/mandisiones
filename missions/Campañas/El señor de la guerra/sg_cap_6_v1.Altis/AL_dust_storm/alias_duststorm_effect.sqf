...
[] spawn {
	...
	while {col_fct>0.86} do {
		"colorCorrections" ppEffectAdjust [col_fct, 1, 0, [0.0, 0.0, 0.0, col_fct-1], [col_fct, 1.8, col_fct, col_fct],  [0.199, col_fct, 0.114, col_fct]];
...
/*col_fct =0.86;
	while {col_fct<1} do {
		"colorCorrections" ppEffectAdjust [col_fct, 1, 0, [1-col_fct, 0.0, 0.0, col_fct-1], [col_fct, 1.8, col_fct, col_fct],  [0.199, 0.587, 0.114,  1-col_fct]];
