...
#define NAME "Capítulo I"
#define COMPLETE_NAME "Capítulo I - El Señor de la Guerra v5"
...
INTRO = 3;                                  // Intros: 1 y 2. Para desactivar: 0
